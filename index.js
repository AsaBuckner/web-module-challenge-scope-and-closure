...
/*Task 1: counterMaker()
  ...
  counter1 returns thr counter() function and keeps track of the previous score
  2. Which of the two uses a closure? How can you tell?
  counter2 does not keep track of the score previously itterated
...
function finalScore(inningCB,innings){
  ...
  for(let i = 0; i < innings; i++){
    final.Home = final.Home + inningCB()
    final.Away = final.Away + inningCB()
  }
  return final
}
